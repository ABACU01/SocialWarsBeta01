...
port = int(os.environ.get("PORT", 8080))  # Usa el puerto asignado por Railway, si no está disponible, usa 8080.
...
def static_assets_loader(path):
    ...
    if False:
cdn = "https://raw.githubusercontent.com/ABACU01/SocialWarsBeta01/main/assets/flash/"
        try:
